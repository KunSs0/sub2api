...
func (_u *UsageLogUpdate) SetTimingBreakdown(v map[string]int) *UsageLogUpdate {
...
// SetTimingBreakdown sets the "timing_breakdown" field.
func (_u *UsageLogUpdateOne) SetTimingBreakdown(v map[string]int) *UsageLogUpdateOne {
	_u.mutation.SetTimingBreakdown(v)
	return _u
}
