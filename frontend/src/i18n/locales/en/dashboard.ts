export default {
  ...
  usage: {
    ...
    latencyBreakdown: 'Timing breakdown',
    latencyAuth: 'Auth',
    latencyRouting: 'Routing',
    latencyDispatch: 'Before dispatch',
    latencyHeader: 'Upstream headers',
    latencyFirstRead: 'First raw data',
    latencyFirstEvent: 'First complete event',
    latencyOutputItemFirst: 'First output item',
    latencyInProgress: 'In progress',
    latencyOutputItemWait: 'In progress → first output item',
    latencyHeaderToFirst: 'Headers → first',
    latencySemanticFirst: 'Semantic first',
    latencyVisibleFirst: 'Visible first',
    latencyAnswerFirst: 'Answer first',
    latencyReasoningFirst: 'Reasoning first',
    latencyToolFirst: 'Tool first',
    latencyAfterFirst: 'After first',
    latencyMaxEventGap: 'Max event gap',
    latencyEventCount: 'Complete event count',
    latencyFirstEventType: 'First event type',
    latencyOutputItemType: 'Output item event type',
    latencyOutputItemItemType: 'First output item type',
    latencyAnswerType: 'Answer event type',
    latencyReasoningType: 'Reasoning event type',
    latencyToolType: 'Tool event type',
    latencySemanticType: 'Semantic event type',
    latencyVisibleType: 'Visible event type',
    latencyMaxGapRange: 'Max gap range',
    latencyUpstreamCompleted: 'Upstream completed',
    latencyForward: 'Forward total',
    latencyCopy: 'Copy timing details',
    latencyCopied: 'Timing details copied',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
