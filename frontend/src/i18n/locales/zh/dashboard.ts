export default {
  ...
  usage: {
    ...
    latencyDuration: '总耗时',
    latencyBreakdown: '耗时拆分',
    latencyAuth: '鉴权',
    latencyRouting: '路由',
    latencyDispatch: '发出前',
    latencyHeader: '上游响应头',
    latencyFirstRead: '首个原始数据',
    latencyFirstEvent: '首个完整事件',
    latencyOutputItemFirst: '首个输出项',
    latencyInProgress: '进入处理中',
    latencyOutputItemWait: '处理中→首个输出项',
    latencyHeaderToFirst: '响应头→首字',
    latencySemanticFirst: 'Semantic 首字',
    latencyVisibleFirst: 'Visible 首字',
    latencyAnswerFirst: '答案首字',
    latencyReasoningFirst: '推理首字',
    latencyToolFirst: '工具首字',
    latencyAfterFirst: '首字后',
    latencyMaxEventGap: '最大事件空档',
    latencyEventCount: '完整事件数',
    latencyFirstEventType: '首个事件类型',
    latencyOutputItemType: '输出项事件类型',
    latencyOutputItemItemType: '首个输出项类型',
    latencyAnswerType: '答案事件类型',
    latencyReasoningType: '推理事件类型',
    latencyToolType: '工具事件类型',
    latencySemanticType: 'Semantic 事件类型',
    latencyVisibleType: 'Visible 事件类型',
    latencyMaxGapRange: '最大空档范围',
    latencyUpstreamCompleted: '上游完成',
    latencyForward: '转发总计',
    latencyCopy: '复制耗时信息',
    latencyCopied: '耗时信息已复制',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
